...
// Generated by macOS NSArchiver from the synthetic attributed string below.
@Test
func linuxDecodesNativeAttributedBody() throws {
  let data = try #require(
    Data(
      base64Encoded:
        "BAtzdHJlYW10eXBlZIHoA4QBQISEhBJOU0F0dHJpYnV0ZWRTdHJpbmcAhIQITlNPYmplY3QAhZKEhIQI"
        + "TlNTdHJpbmcBlIQBKw5sZWZ0IOKGhCByaWdodIaEAmlJAQyShISEDE5TRGljdGlvbmFyeQCUhAFpAIaG"
    ))
  #expect(TypedStreamParser.parseAttributedBody(data) == "left ↄ right")
}
