...
- fix: coalesce GUID-linked and consecutive link-preview rows from one text send, including when the text row omits the preview URL, so watch, history, stats, and unread chat counts expose one logical message.
