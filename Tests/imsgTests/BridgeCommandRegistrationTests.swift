...
func injectedHelperBroadcastsFailClosedNativePollVoteMetadata() throws {
  ...
  #expect(source.contains("Poll option payload exceeds 4096 bytes"))
  ...
  #expect(source.contains("handleSendPollAddOption"))
  #expect(source.contains("buildPollAddOptionPayloadData"))
  #expect(source.contains(#""send-poll-add-option"]"#))
